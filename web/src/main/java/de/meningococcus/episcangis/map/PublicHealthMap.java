...
public class PublicHealthMap extends AbstractWmsMap
{
  private static Log log = LogFactory.getLog(PublicHealthMap.class);
  ...
  {
    return new PublicHealthMapLayerFactory();
  }
