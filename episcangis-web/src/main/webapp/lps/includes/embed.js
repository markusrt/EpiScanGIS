...
function lzHistEmbed(wr) {
    ...
    document.write("<div id='lzhist' style='position:absolute;left:0px;top:0px;'><iframe src='"+top.webapproot+"/lps/includes/h.html' name='_lzhist' frameborder='0' scrolling='no' width='22' height='0'></iframe></div>");
...
'<param name="movie" value="'+top.webapproot+'/lps/includes/h.swf" />' +
...
'<embed id="utilityEmbed" name="h.swf" src="'+top.webapproot+'/lps/includes/h.swf" type="application/x-shockwave-flash" flashvars="n='+ escape(n) + '&v=' + escape(v) +'&__lzevent=1&__lzhistconn='+top.connuid+'" profile="false" quality="high" bgcolor="#FFFFFF" width="0" height="1" align="" pluginspage="http://www.macromedia.com/go/getflashplayer"></embed>' +
'</object>';
    //alert(o);
    if (h) {
        top.frames['_lzhist'].location = top.webapproot+'/lps/includes/h.html?n='+ escape(n) + '&v=' + escape(v) +'&__lzevent=1';
    } else {
        if (document.layers) {
